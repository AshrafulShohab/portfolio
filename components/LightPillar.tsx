  ...
  useEffect(() => {
    ...
    try {
      renderer = new THREE.WebGLRenderer({
        ...
        precision: 'mediump', // Downgraded from lowp for balance, or mediump is fine
        stencil: false,
        depth: false
      });
    } catch (error) {
    ...
    // OPTIMIZATION: Cap pixel ratio to 1.5 to improve performance on 4k/Retina screens
    ...
    const handleMouseMove = (event: MouseEvent) => {
      ...
      // Use window coordinates for fullscreen interactive background
